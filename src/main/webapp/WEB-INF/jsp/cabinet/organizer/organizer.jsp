        ...
        <c:forEach items="${notes}" var="n">
            <div class="col-lg-12 margin-top-15 note-item-border">
                <div class="col-lg-7 " title="${n.text}">
                    <span class="truncate-note-organizer note-text-size"><a href="#"class="editable editable-container editable-inline"
                                                                        data-type="textarea"
                                                                        data-pk="${n.id}"
                                                                        data-name="text"
                                                                        data-url="/cabinet/organizer/editField"
                                                                        data-title="Текст нотатки">${n.text}</a></span></div>
                <div class="col-lg-2 ">
                ...
                <div class="col-lg-1">
                    <i onclick="remove(${n.id})" class="fa fa-remove btn-cursor"></i>
                </div>
            </div>
        </c:forEach>
    </div>
